package com.example.exibirimagens
...
import com.example.exibirimagens.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val errorImage = ("https://gamestation.com.br/wp-content/themes/game-station/images/image-not-found.png")
        ...
        fun mudaImagem() {
            var imagemRandom = urlImages.random()
            Glide.with(this)
                .load(imagemRandom)
                .override(330, 330)
                .centerCrop()
                ...
                .apply(RequestOptions()
                    .error(Glide.with(this).load(errorImage )))
        }

        mudaImagem()

        binding.button.setOnClickListener { mudaImagem() }
